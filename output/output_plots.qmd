...
suc_stats_wide <- suc_summary_stats|>
  rename(
    ...
    "Mean of Detected (ng/L)" = mean_detect,
    "% Detects" = perc_detect,
    "% non-Detects" = perc_non)

#transposing into a long table with 1st row as column names
suc_stats_long <- t(suc_stats_wide)|>
    row_to_names(row_number = 1)

tab2 <- gt(suc_stats_wide)
tab2
gtsave(tab2, filename = "suc_table_wide.png")
```
