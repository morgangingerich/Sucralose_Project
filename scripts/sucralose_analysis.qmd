...
###Literature Review SUC analysis
```{r}
mawhinney_suc <- readr::read_csv("C:/Users/mgingerich/OneDrive - Edwards Aquifer Authority/Desktop/Sucralose_Project/data/Mawhinney_SUC_data.csv")
mawhinney_suc|>
  filter(influence == "ww")
```
